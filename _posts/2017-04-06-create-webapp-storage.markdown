...
1. 새로만들기를 클릭합니다.
![그림](/img/webapp/storage/login_success.png)
2. `Storage -> Storage account - blob, file, table, queue`를 클릭합니다.
![그림](/img/webapp/storage/webapp-srotage.PNG)
3. 다음과 같이 입력하고 확인을 클릭합니다.
![그림](/img/webapp/storage/storage-create.PNG)
...
![그림](/img/webapp/storage/webapp-blob.png)
5. 파일을 저장하기위한 컨테이너를 추가합니다
![그림](/img/webapp/storage/webapp-create-container.png)
...
![그림](/img/webapp/storage/webapp-file-upload.png)
7. 업로드를 완료하면 다음과 같이 URL을 통해 파일에 접근할 수 있습니다.
![그림](/img/webapp/storage/webapp-upload-success.png)
![그림](/img/webapp/storage/webapp-storage-success.png)
8. 메뉴에 액새스 이름과 키를 메모합니다.
![그림](/img/webapp/storage/webapp-storage-key.png)
...
![그림](/img/webapp/storage/webapp-storage-webapp.png)
